module Types
    module AdvancedSearch
        class DiseaseSearchFilterType < Types::BaseInputObject
            ...
            argument :display_name, Types::AdvancedSearch::StringSearchInput, required: false
            ...
            # argument :my_disease_info, Types::AdvancedSearch::MyDiseaseInfoSearchFilterType, required: false
