module Types
    module AdvancedSearch
        class TherapySearchFilterType < Types::BaseInputObject
            ...
            # argument :my_chem_info, Types::AdvancedSearch::MyChemInfoSearchFilterType, required: false
            ...
            # argument :therapy_url, Types::AdvancedSearch::StringSearchInput, required: false
        end
    end
end