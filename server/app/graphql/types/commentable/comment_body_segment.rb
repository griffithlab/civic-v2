module Types::Commentable
  class CommentBodySegment < Types::BaseUnion
    ...
    possible_types Types::Commentable::CommentTagSegment, Types::Commentable::CommentTagSegmentFlagged, Types::Commentable::CommentTagSegmentFlaggedAndDeprecated, Types::Commentable::CommentTextSegment, Types::Entities::UserType
    ...
    def self.resolve_type(object, context)
      ...
      elsif object[:tag_type] == 'VARIANT_GROUP' || object[:tag_type] == 'EVIDENCE_ITEM' || object[:tag_type] == 'ASSERTION'
