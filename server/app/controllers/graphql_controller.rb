class GraphqlController < ApplicationController
  ...
  # Caps a multiplex request at MAX_BATCH_SIZE operations; uncapped, one
  # request can ask for unbounded work. The cap matches default_max_page_size:
  # the schema already serves 100 fully nested nodes per browse page, and a
  # batched tag lookup is one entity and about six scalars. The client's
  # batchMax is 25.
  #
