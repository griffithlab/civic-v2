#!/usr/bin/env node
/**
 * Summarize or diff an esbuild metafile from `yarn build:stats`. The build's
 * own report can't say which feature a lazy chunk belongs to, or whether a
 * change moved weight out of a lazy chunk or up into `main`.
 *
 * Usage:
