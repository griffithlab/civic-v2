...
import { CvcMolecularProfileFusionVariantCardComponent } from './molecular-profile-fusion-variant-card.component'

@NgModule({
  declarations: [CvcMolecularProfileFusionVariantCardComponent],
  imports: [
    CommonModule,
    RouterModule,
    NzTagModule,
  ...
  exports: [CvcMolecularProfileFusionVariantCardComponent],
})
export class CvcMolecularProfileFusionVariantCardModule {}
