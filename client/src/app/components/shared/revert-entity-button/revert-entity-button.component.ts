...
import { EvidenceStatus, Maybe, Organization, RevertAssertionGQL, RevertAssertionMutation, RevertAssertionMutationVariables, RevertEvidenceItemGQL, RevertEvidenceItemMutation, RevertEvidenceItemMutationVariables, SubscribableEntities, SubscribableInput, SubscribeGQL, SubscribeMutation, SubscribeMutationVariables, SubscriptionForEntityGQL, SubscriptionForEntityQuery, SubscriptionForEntityQueryVariables, SubscriptionIdFragment, UnsubscribeGQL, UnsubscribeMutation, UnsubscribeMutationVariables } from "@app/generated/civic.apollo";
...
export class CvcRevertEntityButtonComponent implements OnInit, OnDestroy {
  ...
  revertEvidenceMutator: MutatorWithState<RevertEvidenceItemGQL, RevertEvidenceItemMutation, RevertEvidenceItemMutationVariables>
  revertAssertionMutator: MutatorWithState<RevertAssertionGQL, RevertAssertionMutation, RevertAssertionMutationVariables>
  ...
  constructor(private revertEvidenceGQL: RevertEvidenceItemGQL, private  revertAssertionGQL: RevertAssertionGQL, private networkErrorService: NetworkErrorsService) {
