...
@Component({
  selector: 'cvc-resolve-flag',
  templateUrl: './resolve-flag.component.html',
  styleUrls: ['./resolve-flag.component.less'],
})
export class ResolveFlagComponent implements OnInit {
  @Input() flagId!: number;
