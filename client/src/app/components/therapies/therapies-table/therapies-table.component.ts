...
import { BrowseTherapyConnection, Maybe, PageInfo, TherapiesBrowseGQL, TherapiesBrowseQuery, TherapiesBrowseQueryVariables, TherapyBrowseTableRowFieldsFragment, TherapySortColumns } from '@app/generated/civic.apollo';
...
export class CvcTherapiesTableComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.connection$ = this.result$
      .pipe(pluck('data', 'therapies'),
        filter(isNonNulled)) as Observable<BrowseTherapyConnection>;
