...
export type QuicksearchQuery = { __typename: 'Query', search: Array<{ __typename: 'SearchResult', id: number, resultType: Types.SearchableEntities, name: string, matchingText: string, link: string }> };

export type QuicksearchResultFragment = { __typename: 'SearchResult', id: number, resultType: Types.SearchableEntities, name: string, matchingText: string, link: string };
