import { RevisableAssertionFieldsFragment } from '@app/forms/config/assertion-revise/assertion-revise.query.gql.generated'
import {
  Maybe,
...
export function assertionToModelFields(
  a: RevisableAssertionFieldsFragment
): AssertionFields {
  return {
...
export function assertionFormModelToInput(
  model: AssertionSubmitModel
): Maybe<SubmitAssertionInput> {
...
export function assertionFormModelToReviseInput(
  aid: number,
  model: AssertionReviseModel
): Maybe<SuggestAssertionRevisionInput> {
