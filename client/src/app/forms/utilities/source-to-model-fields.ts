import { Maybe, SuggestSourceInput } from '@app/generated/civic.apollo.types'
...
export function sourceFormModelToInput(
  model: SourceModel
): Maybe<SuggestSourceInput> {
  const fields = model.fields
  const requiredFields = [model.comment, fields.sourceId]
