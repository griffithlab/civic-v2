 ...
 *
 * Not a standalone conversion: the manager still renders cvc-entity-tag-list
 * and cvc-entity-collection-tag, which have no equivalent in app/tags yet.
 * The field's formly registration lives in the shared select registry; this
 * module only declares components.
 */
@NgModule({
  declarations: [
