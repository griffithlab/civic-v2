...
export const variantOriginSelectTypeOption: TypeOption = {
  ...
  defaultOptions: {
    templateOptions: {
      ...
      options: [
        {
          value: VariantOrigin.Somatic,
          label: formatEvidenceEnum(VariantOrigin.Somatic),
        },
        {
          value: VariantOrigin.RareGermline,
          label: formatEvidenceEnum(VariantOrigin.RareGermline),
        },
        {
          value: VariantOrigin.CommonGermline,
          label: formatEvidenceEnum(VariantOrigin.CommonGermline),
        },
        {
          value: VariantOrigin.Unknown,
          label: formatEvidenceEnum(VariantOrigin.Unknown),
        },
        {
          value: VariantOrigin.Na,
          label: formatEvidenceEnum(VariantOrigin.Na),
        },
        {
          value: VariantOrigin.Mixed,
          label: formatEvidenceEnum(VariantOrigin.Mixed),
        },
      ],
    },
