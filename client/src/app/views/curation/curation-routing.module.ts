...
const routes: Routes = [
  {
    ...
    children: [
      { path: '', redirectTo: 'activity', pathMatch: 'full' },
      {
        ...
        loadChildren: () =>
          import(
            '@app/views/curation/curation-activity/curation-activity.module'
          ).then((m) => m.CurationActivityModule),
        data: {
          breadcrumb: 'Activity',
        },
      },
      {
        ...
        loadChildren: () =>
          import(
            '@app/views/curation/curation-queues/curation-queues.module'
          ).then((m) => m.CurationQueuesModule),
        data: {
          breadcrumb: 'Queues',
        },
      },
