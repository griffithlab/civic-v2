...
import { TherapiesSummaryQuery, TherapiesSummaryQueryVariables, TherapiesSummaryFieldsFragment, TherapiesSummaryGQL } from '@app/generated/civic.apollo';
...
export class TherapiesSummaryComponent implements OnDestroy {
  ...
  constructor(
    private route: ActivatedRoute, private gql: TherapiesSummaryGQL
  ) {
