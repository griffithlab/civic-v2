...
export type ActivityFeedCountQueryVariables = Exact<{
  subject?: InputMaybe<SubscribableQueryInput>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  before?: InputMaybe<Scalars['String']>;
...
export type ActivityFeedCountQuery = { __typename: 'Query', events: { __typename: 'EventConnection', unfilteredCount: number } };
...
export const ActivityFeedNodeFragmentDoc = gql`
    fragment activityFeedNode on Event {
  id
  action
  createdAt
  organization {
...
export const ActivityFeedFragmentDoc = gql`
    fragment activityFeed on EventConnection {
  pageInfo {
    startCursor
    endCursor
    hasNextPage
...
export const ActivityFeedCountDocument = gql`
    query ActivityFeedCount($subject: SubscribableQueryInput, $first: Int, $last: Int, $before: String, $after: String, $originatingUserId: Int, $organizationId: Int, $eventType: EventAction, $includeAutomatedEvents: Boolean, $mode: EventFeedMode) {
  events(
    subject: $subject
    first: $first
    last: $last
  ...
  export class ActivityFeedCountGQL extends Apollo.Query<ActivityFeedCountQuery, ActivityFeedCountQueryVariables> {
    document = ActivityFeedCountDocument;
...
export const ActivityFeedDocument = gql`
    query ActivityFeed($subject: SubscribableQueryInput, $first: Int, $last: Int, $before: String, $after: String, $originatingUserId: Int, $organizationId: Int, $eventType: EventAction, $mode: EventFeedMode, $includeAutomatedEvents: Boolean = true, $showFilters: Boolean!) {
  events(
    subject: $subject
    first: $first
    last: $last
