...
export const ActivityItemDocument = gql`
    query ActivityItem($id: Int!) {
  activity(id: $id) {
    id
    note
    events {
  ...
  export class ActivityItemGQL extends Apollo.Query<ActivityItemQuery, ActivityItemQueryVariables> {
    document = ActivityItemDocument;
