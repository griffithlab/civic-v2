...
export type CountsAndTotalsWithSubset = {
  __typename: 'CountsAndTotalsWithSubset';
  primaryCounts: CountsAndTotals;
  subsetCounts: Array<CountsAndTotalWithKey>;
};
...
export type Query = {
  ...
  evidenceItems: EvidenceItemConnection;
  evidenceTypeCounts: CountsAndTotalsWithSubset;
...
export type TopGenesByVariantsQuery = { __typename: 'Query', topGenesByVariants: { __typename: 'CountsAndTotals', total: number, secondaryTotal?: number | undefined, counts: Array<{ __typename: 'NameWithCount', name: string, count: number, link?: string | undefined }> } };

export type EvidenceTypeCountsQueryVariables = Exact<{ [key: string]: never; }>;


export type EvidenceTypeCountsQuery = { __typename: 'Query', evidenceTypeCounts: { __typename: 'CountsAndTotalsWithSubset', primaryCounts: { __typename: 'CountsAndTotals', total: number, counts: Array<{ __typename: 'NameWithCount', name: string, count: number }> }, subsetCounts: Array<{ __typename: 'CountsAndTotalWithKey', key: string, counts: { __typename: 'CountsAndTotals', total: number, counts: Array<{ __typename: 'NameWithCount', name: string, count: number }> } }> } };

export type SubsetCountsFragment = { __typename: 'CountsAndTotalWithKey', key: string, counts: { __typename: 'CountsAndTotals', total: number, counts: Array<{ __typename: 'NameWithCount', name: string, count: number }> } };
