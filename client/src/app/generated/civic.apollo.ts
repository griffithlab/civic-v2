...
export type CountsAndTotalWithKey = {
  __typename: 'CountsAndTotalWithKey';
  counts: CountsAndTotals;
  key: Scalars['String'];
};

export type CountsAndTotals = {
  __typename: 'CountsAndTotals';
  counts: Array<NameWithCount>;
  secondaryTotal?: Maybe<Scalars['Int']>;
  total?: Maybe<Scalars['Int']>;
};

export type CountsWithKey = {
  __typename: 'CountsWithKey';
  counts: Array<NameWithCount>;
  key: Scalars['String'];
};
...
export type EvidenceImpactCounts = {
  __typename: 'EvidenceImpactCounts';
  evidenceByDisease: Array<NameWithCount>;
  evidenceByType: Array<NameWithCount>;
};
...
export type EvidenceTypeCounts = {
  __typename: 'EvidenceTypeCounts';
  clinicalSignificanceCounts: Array<CountsAndTotalWithKey>;
  evidenceTypeCounts: CountsAndTotals;
  supportCounts: Array<SeriesWithKey>;
};
...
export type Query = {
  ...
  ampCategoryCounts: CountsAndTotals;
  ...
  /** List and filter events for an object */
  events: EventConnection;
  evidenceForGene: EvidenceImpactCounts;
  ...
  evidenceStatusCounts: Array<NameWithCount>;
  ...
  topDiseasesByEvidence: CountsAndTotals;
  topGenesByVariants: CountsAndTotals;
  user?: Maybe<User>;
...
export type QueryEvidenceForGeneArgs = {
  diseaseId?: InputMaybe<Scalars['Int']>;
  geneId: Scalars['Int'];
};
...
export type SeriesWithKey = {
  __typename: 'SeriesWithKey';
  key: Scalars['String'];
  series: Array<CountsWithKey>;
};
...
export type TopGenesByVariantsQuery = { __typename: 'Query', topGenesByVariants: { __typename: 'CountsAndTotals', total?: number | undefined, secondaryTotal?: number | undefined, counts: Array<{ __typename: 'NameWithCount', name: string, link?: string | undefined, value: number }> } };

export type TopDiseasesByEvidenceQueryVariables = Exact<{ [key: string]: never; }>;


export type TopDiseasesByEvidenceQuery = { __typename: 'Query', topDiseasesByEvidence: { __typename: 'CountsAndTotals', total?: number | undefined, secondaryTotal?: number | undefined, counts: Array<{ __typename: 'NameWithCount', name: string, link?: string | undefined, value: number }> } };

export type EvidenceLevelCountsQueryVariables = Exact<{ [key: string]: never; }>;


export type EvidenceLevelCountsQuery = { __typename: 'Query', evidenceLevelCounts: Array<{ __typename: 'NameWithCount', name: string, value: number }> };

export type EvidenceRatingCountsQueryVariables = Exact<{ [key: string]: never; }>;


export type EvidenceRatingCountsQuery = { __typename: 'Query', evidenceRatingCounts: Array<{ __typename: 'NameWithCount', name: string, value: number }> };

export type EvidenceStatusCountsQueryVariables = Exact<{ [key: string]: never; }>;


export type EvidenceStatusCountsQuery = { __typename: 'Query', evidenceStatusCounts: Array<{ __typename: 'NameWithCount', name: string, value: number }> };

export type AmpLevelCountsQueryVariables = Exact<{ [key: string]: never; }>;


export type AmpLevelCountsQuery = { __typename: 'Query', ampCategoryCounts: { __typename: 'CountsAndTotals', total?: number | undefined, counts: Array<{ __typename: 'NameWithCount', name: string, value: number }> } };

export type EvidenceTypeCountsQueryVariables = Exact<{ [key: string]: never; }>;


export type EvidenceTypeCountsQuery = { __typename: 'Query', evidenceTypeCounts: { __typename: 'EvidenceTypeCounts', evidenceTypeCounts: { __typename: 'CountsAndTotals', total?: number | undefined, counts: Array<{ __typename: 'NameWithCount', name: string, value: number }> }, clinicalSignificanceCounts: Array<{ __typename: 'CountsAndTotalWithKey', key: string, counts: { __typename: 'CountsAndTotals', total?: number | undefined, counts: Array<{ __typename: 'NameWithCount', name: string, value: number }> } }>, supportCounts: Array<{ __typename: 'SeriesWithKey', key: string, series: Array<{ __typename: 'CountsWithKey', name: string, series: Array<{ __typename: 'NameWithCount', name: string, value: number }> }> }> } };

export type SubsetCountsFragment = { __typename: 'CountsAndTotalWithKey', key: string, counts: { __typename: 'CountsAndTotals', total?: number | undefined, counts: Array<{ __typename: 'NameWithCount', name: string, value: number }> } };

export type SupportCountsFragment = { __typename: 'SeriesWithKey', key: string, series: Array<{ __typename: 'CountsWithKey', name: string, series: Array<{ __typename: 'NameWithCount', name: string, value: number }> }> };
...
export type EvidenceForGeneQueryVariables = Exact<{
  geneId: Scalars['Int'];
  diseaseId?: InputMaybe<Scalars['Int']>;
}>;


export type EvidenceForGeneQuery = { __typename: 'Query', evidenceForGene: { __typename: 'EvidenceImpactCounts', evidenceByDisease: Array<{ __typename: 'NameWithCount', name: string, link?: string | undefined, value: number, entityId?: number | undefined }>, evidenceByType: Array<{ __typename: 'NameWithCount', name: string, value: number }> } };
...
export const AssertionSummaryFieldsFragmentDoc = gql`
  ...
  rejectionEvent {
    ...
    ${MolecularProfileParsedNameFragmentDoc}`;
export const SubsetCountsFragmentDoc = gql`
    fragment SubsetCounts on CountsAndTotalWithKey {
  key
  counts {
    counts {
      name
    ...
    `;
export const SupportCountsFragmentDoc = gql`
    fragment SupportCounts on SeriesWithKey {
  key
  series {
    name: key
    series: counts {
...
export const TopDiseasesByEvidenceDocument = gql`
    query TopDiseasesByEvidence {
  topDiseasesByEvidence {
    total
    counts {
      name
      value: count
  ...
  export class TopDiseasesByEvidenceGQL extends Apollo.Query<TopDiseasesByEvidenceQuery, TopDiseasesByEvidenceQueryVariables> {
    document = TopDiseasesByEvidenceDocument;
...
export const EvidenceStatusCountsDocument = gql`
    query EvidenceStatusCounts {
  ...
  export class EvidenceStatusCountsGQL extends Apollo.Query<EvidenceStatusCountsQuery, EvidenceStatusCountsQueryVariables> {
    document = EvidenceStatusCountsDocument;
    
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const AmpLevelCountsDocument = gql`
    query AmpLevelCounts {
  ampCategoryCounts {
    total
    counts {
      name
  ...
  export class AmpLevelCountsGQL extends Apollo.Query<AmpLevelCountsQuery, AmpLevelCountsQueryVariables> {
    document = AmpLevelCountsDocument;
    
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const EvidenceTypeCountsDocument = gql`
    query EvidenceTypeCounts {
  evidenceTypeCounts {
    evidenceTypeCounts {
      counts {
        value: count
    ...
    ${SubsetCountsFragmentDoc}
${SupportCountsFragmentDoc}`;

  @Injectable({
    providedIn: 'root'
  })
  export class EvidenceTypeCountsGQL extends Apollo.Query<EvidenceTypeCountsQuery, EvidenceTypeCountsQueryVariables> {
    document = EvidenceTypeCountsDocument;
...
export const EvidenceForGeneDocument = gql`
    query EvidenceForGene($geneId: Int!, $diseaseId: Int) {
  evidenceForGene(geneId: $geneId, diseaseId: $diseaseId) {
    evidenceByDisease {
      name
      value: count
      link
  ...
  export class EvidenceForGeneGQL extends Apollo.Query<EvidenceForGeneQuery, EvidenceForGeneQueryVariables> {
    document = EvidenceForGeneDocument;
