...
export const ActivityFeedItemBaseFragmentDoc = gql`
  ...
  note @include(if: $requestDetails)
    ...
    `;
export const FlagEntityActivityDetailsFragmentDoc = gql`
    fragment FlagEntityActivityDetails on FlagEntityActivity {
...
export const CommentActivityDetailsFragmentDoc = gql`
...
export const ActivityFeedItemFragmentDoc = gql`
  ...
  ...CommentActivityDetails @include(if: $requestDetails)
    ...
    ${ActivityFeedItemBaseFragmentDoc}
${CommentActivityDetailsFragmentDoc}`;
